...
{
  new (message_memory) interfaces::msg::Dect(_init);
}

void Dect_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::Dect *>(message_memory);
  typed_message->~Dect();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Dect_message_member_array[6] = {
  {
    ...
    offsetof(interfaces::msg::Dect, obj_class),  // bytes offset in struct
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Dect_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, Dect)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Dect_message_type_support_handle;
}
