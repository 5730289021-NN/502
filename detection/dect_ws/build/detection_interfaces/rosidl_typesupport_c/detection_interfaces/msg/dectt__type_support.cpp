...
#include "detection_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Dectt_type_support_symbol_names_t _Dectt_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detection_interfaces, msg, Dectt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, detection_interfaces, msg, Dectt)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_detection_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, detection_interfaces, msg, Dectt)() {
  return &::detection_interfaces::msg::rosidl_typesupport_c::Dectt_message_type_support_handle;
}
