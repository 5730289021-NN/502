...
bool detection_interface__msg__dect__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("detection_interface.msg._dect.Dect", full_classname_dest, 34) == 0);
  }
  detection_interface__msg__Dect * ros_message = _ros_message;
  {  // obj_class
...
PyObject * detection_interface__msg__dect__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("detection_interface.msg._dect");
