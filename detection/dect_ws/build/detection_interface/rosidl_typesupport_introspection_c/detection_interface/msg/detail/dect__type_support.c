...
#include <stddef.h>
#include "detection_interface/msg/detail/dect__rosidl_typesupport_introspection_c.h"
#include "detection_interface/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  detection_interface__msg__Dect__init(message_memory);
}

void Dect__rosidl_typesupport_introspection_c__Dect_fini_function(void * message_memory)
{
  detection_interface__msg__Dect__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Dect__rosidl_typesupport_introspection_c__Dect_message_member_array[2] = {
  {
    "obj_class",  // name
    ...
    offsetof(detection_interface__msg__Dect, obj_class),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(detection_interface__msg__Dect, bound_coor),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Dect__rosidl_typesupport_introspection_c__Dect_message_members = {
  "detection_interface__msg",  // message namespace
  "Dect",  // message name
  2,  // number of fields
  sizeof(detection_interface__msg__Dect),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_detection_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, detection_interface, msg, Dect)() {
