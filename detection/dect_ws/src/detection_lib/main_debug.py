...
def dectshow(org_img, boxs,depth_data):
    ...
    for box in boxs:
        ...
        box_and_dist.append([box[0],box[1],box[2],box[3],dist])
        obj_class.append(box[-1])
    # cv2.imshow('dec_img', img)
    return box_and_dist, obj_class

def dectrun(depth_frame,color_frame):
    ...
    return dectshow(color_image, boxs, depth_image)
