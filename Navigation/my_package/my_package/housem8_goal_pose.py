...
import rclpy
from housem8_interfaces.srv import Goaly
...
class MinimalService(Node):
    def __init__(self):
        ...
        self.srv = self.create_service(Goaly, '/housem8/goal', self.goal_callback)
    ...
    def goal_callback(self, request, response):
        ...
        goal_pose.pose.position.z = request.z
        qw, qx, qy, qz = self.get_quaternion_from_euler(request.roll, request.pitch, request.yaw)
